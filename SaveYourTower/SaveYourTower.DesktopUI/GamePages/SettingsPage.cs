...
namespace SaveYourTower.DesktopUI.GamePages
{
    public partial class SettingsPage : UserControl, ILoadable
    {
        ...
        private void lblFullScreen_Click(object sender, EventArgs e)
        {
            ...
            {
                ((SaveYourTowerForm)this.Parent).FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
                ((SaveYourTowerForm)this.Parent).WindowState = FormWindowState.Maximized;
            }
            else
            {
                ((SaveYourTowerForm)this.Parent).FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedDialog;
                ((SaveYourTowerForm) this.Parent).WindowState = FormWindowState.Normal;
            }
        }
